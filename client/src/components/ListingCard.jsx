  ...
  return (
    <div className='relative bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition'>
        ...
        {listing.featured && (
            <>
                <p className='py-1'/>
                <div className='absolute top-0 left-0 w-full bg-gradient-to-r from-pink-500 to purple-500 text-white text-center text-xs from-semibold py-1 tracking-wide uppercase'>Featured</div>
            </>
        )}
